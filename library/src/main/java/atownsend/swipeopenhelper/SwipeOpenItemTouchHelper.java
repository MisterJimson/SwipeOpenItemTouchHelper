...
public class SwipeOpenItemTouchHelper extends RecyclerView.ItemDecoration implements RecyclerView.OnChildAttachStateChangeListener {
    ...
    static final String OPENED_STATES = "opened_states";
    ...
    static final String TAG = "SwipeOpenHelper";
    static final boolean DEBUG = false;
    static final int ACTIVE_POINTER_ID_NONE = -1;
    static final int DIRECTION_FLAG_COUNT = 8;
    static final int ACTION_MODE_IDLE_MASK = (1 << DIRECTION_FLAG_COUNT) - 1;
     ...
     */
    final float[] tmpPosition = new float[2];

    /**
     * Currently selected view holder
     */
    SwipeOpenViewHolder selected = null;
    ...
    SwipeOpenViewHolder prevSelected;
    ...
    SparseArray<SavedOpenState> openedPositions = new SparseArray<>();

    final SwipeAdapterDataObserver adapterDataObserver = new SwipeAdapterDataObserver();

    final SwipeOnItemTouchListener mOnItemTouchListener = new SwipeOnItemTouchListener();

    final SwipeOnScrollListener scrollListener = new SwipeOnScrollListener();
    ...
    public SwipeOpenItemTouchHelper(Callback callback) {
        ...
        adapterDataObserver.main = this;
        mOnItemTouchListener.main = this;
        scrollListener.main = this;
    }
     ...
     */
     void select(SwipeOpenViewHolder selected, int actionState) {
    ...
    void endRecoverAnimation(SwipeOpenViewHolder viewHolder, boolean override) {
        final int recoverAnimSize = recoverAnimations.size();
        for (int i = recoverAnimSize - 1; i >= 0; i--) {
     ...
     */
    void closeOpenHolder(SwipeOpenViewHolder holder) {
